...
ALARM_PATH := vendor/au/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/au/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/au/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/au/prebuilt/common/media/audio/ui
